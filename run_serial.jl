...
FileIO.save("../Output/SOEdef_nob.jld", "sd", sd3, "g", g, "pp", p_nob, "pars", pars(sd3), "Wr", Wr)

sd4 = FileIO.load("../Output/SOEdef.jld", "sd")
for (key, val) in pars(sd)
	sd4.pars[key] = val
end
update_probs!(sd4)
...
FileIO.save("../Output/SOEdef_nodelta.jld", "sd", sd4, "g", g, "pp", p_noΔ, "pars", pars(sd4), "Wr", Wr)
