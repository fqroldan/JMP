...
function make_calib_table(v_m)
	...
	rownames = ["AR(1) autocorr.~coef \$\\log(Y_t)\$"; "AR(1) std coef \$\\log(Y_t)\$"; "AR(1) autocorr.~coef \$\\log(C_t)\$"; "AR(1) std coef \$\\log(C_t)\$"; "AR(1) autocorr.~coef spread"; "AR(1) std coef spread"; "Avg Debt-to-GDP	"; "Std Debt-to-GDP	"; "Avg unemployment"; "Std unemployment"; "Median domestic holdings"; "Avg wealth-to-GDP"; "Avg wealth Gini"]
